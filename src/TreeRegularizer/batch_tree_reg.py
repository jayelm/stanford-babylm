...
from tree_projection_src import batched_tree_projection
...
if __name__ == '__main__':
    ...
    with tqdm(total=2) as pbar:
        for i in range(0, 2, args.batch_size):
            #end = min(i + args.batch_size, len(input_strings))
            input_strs = ["I love red apples.", "I love red abcadabras."]#input_strings[i: i+ args.batch_size]
            loss = reg(input_strs)
            print("-"*20)
